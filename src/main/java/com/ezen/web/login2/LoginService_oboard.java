...
import com.ezen.web.login2.LoginOboard;


public class LoginService_oboard {

	private HttpSession session;
	private HttpServletRequest request;
	private HttpServletResponse response;
	private String viewPath = "/WEB-INF/jsp/oboard";
	
	   
	public LoginService_oboard(HttpServletRequest request, HttpServletResponse response) {
	...
	public String startloginsvc() {
		...
		{
			return viewPath+ "/loginForm_oboard.jsp";

		}else if(cmd.equals("login"))
		{
			LoginOboard user = new LoginOboard();
	   ...
	   public boolean login(LoginOboard user)
	   {
